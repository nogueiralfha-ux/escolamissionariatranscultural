...
import { BookOpen, Smartphone, Download, ExternalLink, Library, Headphones, BookMarked, Globe } from 'lucide-react';
import { Link } from 'react-router-dom';

const categories = [
  {
    title: "E-books e Literatura",
    icon: Library,
    description: "Materiais aprofundados para o seu crescimento bíblico e missiológico.",
    items: [
      {
  ...
  },
  {
    ...
    icon: Smartphone,
    description: "Tecnologia a serviço do Reino para te ajudar no dia a dia no campo.",
    items: [
      {
              ...
              {category.items.map((item, itemIdx) => (
                ...
                >
                  ...
                  <div className="p-6 md:p-8 flex flex-col flex-1 justify-center">
                    ...
                    <button className="inline-flex items-center gap-2 font-bold text-mission-orange hover:text-mission-orange-dark transition-colors self-start group">
                      <item.actionIcon className="w-5 h-5" />
                      {item.action}
                    </button>
                  </div>
                </motion.div>
